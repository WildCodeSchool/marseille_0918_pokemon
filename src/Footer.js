    ...
    return (
      <div className="footer-issam">
        ...
        {/* <div className="reseaux"> */}
          <a className="twitter" href="https://twitter.com/?lang=fr"
          ...
          <a className="youtube" href="https://www.youtube.com/?gl=FR"
          // class="twitter-share-button" 
          //data-count="vertical" data-via="InfoWebMaster"
          >
          ...
          <a className="instagram" href="https://www.instagram.com/?hl=fr"
          //class="twitter-share-button" 
          //data-count="vertical" data-via="InfoWebMaster"
          >
          ...
          <a className="facebook" href="https://www.instagram.com/?hl=fr"
          //class="twitter-share-button" 
          //data-count="vertical" data-via="InfoWebMaster"
          >
